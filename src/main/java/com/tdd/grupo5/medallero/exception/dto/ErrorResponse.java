...
public class ErrorResponse {
    ...
    public ErrorResponse(String error, String message, int status) {
        ...
        @JsonCreator
        public ErrorResponse(@JsonProperty("status") int status, @JsonProperty("message") String message, @JsonProperty("error") String error, @JsonProperty("cause") Object cause) {
            this.status = status;
            this.message = message;
            this.error = error;
            this.cause = cause;
